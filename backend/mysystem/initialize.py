...
""")
    ...
    def init_menu(self):
        ...
        self.menu_data = [
            ...
            {'id': '77edf447326b4e0dbc6f9719c1de8a12', 'name': '系统监控', 'sort': 19, 'web_path': '','icon': 'TrendCharts', 'parent_id': None, 'component': None,'component_name': None, 'visible': 1, 'isautopm': 0},
