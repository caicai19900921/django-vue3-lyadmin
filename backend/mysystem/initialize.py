...
""")
    ...
    def init_menu(self):
        ...
        """
        self.menu_data = [
            {'id': '2e3438c8-3ddc-43ff-b8d8-cca328e4856e', 'name': '管理员管理', 'sort': 1, 'web_path': 'adminManage','icon': 'avatar', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm':0},
            ...
            {'id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'name': '系统管理', 'sort': 20,'web_path': 'departmentManage', 'icon': 'tools', 'parent_id': None,'component': None, 'component_name': None, 'visible': 1,'isautopm':0},
