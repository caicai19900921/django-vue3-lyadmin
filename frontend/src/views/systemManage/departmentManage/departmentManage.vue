        ...
        <div class="tableSelect">
            <el-form :inline="true" :model="formInline" label-position="left">
                ...
                <el-form-item label="部门名称：">
                    <el-input size="default" v-model.trim="formInline.name" maxlength="60" placeholder="部门名称" clearable @change="getData" style="width:200px"></el-input>
                </el-form-item>
                <el-form-item label="状态：">
                    <el-select v-model="formInline.status" placeholder="请选择" clearable @change="getData" size="default">
                        <el-option
                ...
                <el-form-item label="">
                    <el-button size="default" type="primary" @click="addDepart" v-show="isShowBtn('departmentManage','部门管理','Create')">新增</el-button>
                </el-form-item>
            </el-form>
        </div>
